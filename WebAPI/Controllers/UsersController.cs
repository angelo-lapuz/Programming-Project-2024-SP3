...
public class UsersController : ControllerBase
{
    ...
    public async Task<IActionResult> ForgotPassword([FromBody] ForgotPasswordViewModel model)
    {
        ...
        var resetLink = $"https://taspeak-bba5hncge9f0e5c0.australiaeast-01.azurewebsites.net/Login/ResetPassword?userId={user.Id}&token={Uri.EscapeDataString(token)}";
    ...
    public async Task<IActionResult> Create([FromBody] RegisterViewModel model) 
    {
...

        {
            ...
            var confirmationLink = $"https://taspeak-bba5hncge9f0e5c0.australiaeast-01.azurewebsites.net/SignUp/ConfirmEmail?userId={user.Id}&token={Uri.EscapeDataString(base64Token)}";
            // creating the email
            var emailBody = $@"
            <html>
            <body>
